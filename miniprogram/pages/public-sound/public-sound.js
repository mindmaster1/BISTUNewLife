...
import { Config } from '../util/utils/config.js';
var util = require('../util/utils/util.js');
Page({
  data: {
    biaobaisex: true,
    hideRecord: true,
    imgDefault: 'https://wechatimages-1302630697.cos.ap-beijing.myqcloud.com/images01/photo.png',
  ...
  bindSubmit: function (event) {
    ...
    if (audioFilePath==null) {
      wx.showToast({
        title: '录音不能为空',
        image: 'https://wechatimages-1302630697.cos.ap-beijing.myqcloud.com/images01/warning.png'
      })
    } else {
      wx.request({
