let utils = require('../../util/utils/utilconfig')
...
Page({
  ...
  data: {
    ...
    bcgImgList: [
      {
        src: 'https://wechatimages-1302630697.cos.ap-beijing.myqcloud.com/weather/beach-bird-birds-235787.jpg',
        topColor: '#393836'
      },
      {
        src: 'https://wechatimages-1302630697.cos.ap-beijing.myqcloud.com/weather/clouds-forest-idyllic-417102.jpg',
        topColor: '#0085e5'
      },
      {
        src: 'https://wechatimages-1302630697.cos.ap-beijing.myqcloud.com/weather/backlit-dawn-dusk-327466.jpg',
        topColor: '#2d2225'
      },
      {
        src: 'https://wechatimages-1302630697.cos.ap-beijing.myqcloud.com/weather/accomplishment-adventure-clear-sky-585825.jpg',
        topColor: '#004a89'
      },
      {
        src: 'https://wechatimages-1302630697.cos.ap-beijing.myqcloud.com/weather/fog-himalayas-landscape-38326.jpg',
        topColor: '#b8bab9'
      },
      {
        src: 'https://wechatimages-1302630697.cos.ap-beijing.myqcloud.com/weather/asphalt-blue-sky-clouds-490411.jpg',
        topColor: '#009ffe'
      },
      {
        src: 'https://wechatimages-1302630697.cos.ap-beijing.myqcloud.com/weather/aerial-climate-cold-296559.jpg',
        topColor: '#d6d1e6'
      },
      {
        src: 'https://wechatimages-1302630697.cos.ap-beijing.myqcloud.com/weather/beautiful-cold-dawn-547115.jpg',
        topColor: '#ffa5bc'
      }
    ],
    bcgImgIndex: 0,
  ...
  onShareAppMessage (res) {
    ...
    return {
      ...
      path: shareInfo.path || '/pages/weather/index/index',
